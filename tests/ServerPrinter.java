...
public class ServerPrinter extends AuctionServer
{
    ...
    @Override
    public boolean submitBid(int listingID, String clientName, int biddingAmount)
    {
        Logger.getInstance().logStart("submitBid", clientName, listingID, biddingAmount);
        
        boolean returnValue = super.submitBid(listingID, clientName, biddingAmount);
    ...
    @Override
    public int checkBidStatus(int listingID, String clientName)
    {
        Logger.getInstance().logStart("checkBidStatus", clientName, listingID);
        
        int returnValue = super.checkBidStatus(listingID, clientName);

...
public class Simulation {
	...
	public static int FryerUsed, OvenUsed, PressUsed, FountainUsed;
	public static ArrayList<Customer> hungryCustomer;
	public static ArrayList<Integer> freeTables;

	//public static Object Fryer, Oven, GrillPress, Fountain;
	public static int MachineCap;
	...
	public static void main(String args[]) throws InterruptedException {
		...
		hungryCustomer = new ArrayList<Customer>(numCustomers);
		freeTables = new ArrayList<Integer>(numTables);
		for (int i=0;i<numTables;i++){
			freeTables.add(i);
		}
		MachineCap = machineCapacity;
